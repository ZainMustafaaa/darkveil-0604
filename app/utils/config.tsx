...
export const useOrderlyConfig = () => {
  ...
  return useMemo<OrderlyConfig>(() => {
    ...
    // Candle color overrides at the top level of tradingViewConfig
    const tradingViewOverrides = {
      "mainSeriesProperties.candleStyle.upColor": "#2bd4ca",
      "mainSeriesProperties.candleStyle.downColor": "#cb2f2f",
      "mainSeriesProperties.candleStyle.borderUpColor": "#2bd4ca",
      "mainSeriesProperties.candleStyle.borderDownColor": "#cb2f2f",
      "mainSeriesProperties.candleStyle.wickUpColor": "#2bd4ca",
      "mainSeriesProperties.candleStyle.wickDownColor": "#cb2f2f",
